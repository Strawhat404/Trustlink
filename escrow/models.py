...
class EscrowTransaction(models.Model):
    ...
    buyer = models.ForeignKey(TelegramUser, on_delete=models.CASCADE, related_name='purchases')
    seller = models.ForeignKey(TelegramUser, on_delete=models.CASCADE, related_name='sales')
    group_listing = models.ForeignKey('groups.GroupListing', on_delete=models.CASCADE)
    
    # Payment details
    amount = models.DecimalField(max_digits=20, decimal_places=8)
    currency = models.CharField(max_length=10, choices=CURRENCY_CHOICES)
    usd_equivalent = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
...
class PaymentWebhook(models.Model):
    ...
    transaction = models.ForeignKey(EscrowTransaction, on_delete=models.CASCADE, related_name='webhooks')
...
class AuditLog(models.Model):
    ...
    transaction = models.ForeignKey(EscrowTransaction, on_delete=models.CASCADE, related_name='audit_logs')
